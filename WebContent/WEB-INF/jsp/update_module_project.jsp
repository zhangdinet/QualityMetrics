...
<body>
	...
	<jsp:include page="commonpart/containerStart.jsp"></jsp:include>
			...
			<h3>更新模块类项</h3>
				<div>
					<label>模块名称</label>
					<input name="project_name" id="project_name" readonly="readonly" value="${project_name }" style="color: grey" class="form-control"></input>
				</div>
				<div>
				...
				<div>
					<label>TestLink系统中Test Suite名称</label>
				...
				<div>
					<label>Redmine系统中Category名称</label>
				...
				<div>
					<input type="hidden" class="btn btn-primary" name="project_id" value="${project_id }"></input>
	...
	$(function(){
		...
		function send(i)
		{
			if (i == 0)
			{
				...
				$("#formModule").attr("action", "saveUpdateModuleProject");
			}
			else if (i == 1)
			{
